...
const createScene = async function() {
    ...
    boxMat.diffuseTexture = new BABYLON.Texture("https://assets.babylonjs.com/textures/semihouse.png");
    box.material = boxMat;
    ...
    // const house = BABYLON.Mesh.MergeMeshes([box, roof]); //@ Merge the box and roof meshes into one mesh called 'house', this way does not work because it merged the walls into the roof so the whole house covered with windows and doors

    const house = BABYLON.Mesh.MergeMeshes([box, roof], true, false, null, false, true); //@ Merge the box and roof meshes into one mesh called 'house'
    ...
    //@ postion the house - option 1
    // house2.position.x = 0;
    // house2.position.y = 0;
    // house2.position.z = -4;

    //@ postion the house - option 2
